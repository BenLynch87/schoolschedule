...
public class ClassDetailActivity extends Activity implements AssessmentAdapter.OnAssessmentClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (classId != -1) {
            ClassEntity existingClass = repository.getClassById(classId);
        ...
        if (classId != -1) {
            ...
            AssessmentAdapter assessmentAdapter = new AssessmentAdapter(assessments,this,this);
